...
const envSchema = z.object({
  ...
  MP_ACCESS_TOKEN: z.string().min(1).optional().or(z.literal('')).transform(v => v || undefined),
  MP_WEBHOOK_SECRET: z.string().min(32).optional().or(z.literal('')).transform(v => v || undefined),
  MP_SUCCESS_URL: z.string().url().optional().or(z.literal('')).transform(v => v || undefined),
  MP_FAILURE_URL: z.string().url().optional().or(z.literal('')).transform(v => v || undefined),
  MP_PENDING_URL: z.string().url().optional().or(z.literal('')).transform(v => v || undefined),

  PAYPAL_CLIENT_ID: z.string().min(1).optional().or(z.literal('')).transform(v => v || undefined),
  PAYPAL_CLIENT_SECRET: z.string().min(1).optional().or(z.literal('')).transform(v => v || undefined),
  PAYPAL_MODE: z.enum(["sandbox", "live"]).default("sandbox"),
  PAYPAL_WEBHOOK_ID: z.string().optional().or(z.literal('')).transform(v => v || undefined),
  PAYPAL_SUCCESS_URL: z.string().url().optional().or(z.literal('')).transform(v => v || undefined),
  PAYPAL_CANCEL_URL: z.string().url().optional().or(z.literal('')).transform(v => v || undefined),
